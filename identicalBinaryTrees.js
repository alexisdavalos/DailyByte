...
const identicalBinaryTrees = (treeA, treeB) => {
...
console.log(identicalBinaryTrees(treeA, treeB)); // => true
...
console.log(identicalBinaryTrees(treeC, treeD)); // => false
...
console.log(identicalBinaryTrees(treeE, treeF)); // => false
